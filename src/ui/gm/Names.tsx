 ...
 * bottom of the window: 852 - 47 - 8 = 797px of panel - measured, that panel
 * is 797.00 - less a 44px title row, so this region gets 753px. It pads `10px
 ...
 * (`Reference.tsx`). The 753 spends neither that border nor the title row's
 * own rule; the same sheet measures 750.00 below its title. 704, 984 and 1060
 * lose 2 apiece by the same rule, derived and not measured. Each number below
 * that starts from 369 - the `369 x 64` of DRAW, the `(369 - 12) / 3 = 119` of
 * the three kinds - inherits it. Measure them before anything leans on them.
 *
