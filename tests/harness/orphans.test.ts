...
const DELIBERATE: Record<string, string> = {
  ...
  'store/backup.ts::installBackupHooks': 'P0-2: the automatic backup Settings claims is running.',
  'store/backup.ts::backupAtSessionEnd': 'P0-2.',
  'store/backup.ts::noteSession': 'P0-2.',
