 ...
 *      class feature. The predicate is `holdsFavor`, asked of the dataset, so
 ...
 * wire, and `holdsFavor` itself; none of that is restated here.
 */
...
describe('who is offered a Favor', () => {
  ...
  it('offers it to a character who multiclassed into the Warlock', () => {
    // `holdsFavor`'s second arm, on the screen. The app already prints "Favor"
